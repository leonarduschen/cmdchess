...
class Board:
    ...
    def initialize_layout(self, algebraic = True):
        ...
        self.layout['D1'].place_piece(Queen('White'))
        self.layout['E1'].place_piece(King('White'))
        ...
        self.layout['D8'].place_piece(Queen('Black'))
        self.layout['E8'].place_piece(King('Black'))
